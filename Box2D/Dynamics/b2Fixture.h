...
public:
	...
	/// may be expensive.
        float32 GetMassData(b2MassData* massData) const;
...
inline float32 b2Fixture::GetMassData(b2MassData* massData) const
{
        return m_shape->ComputeMass(massData, m_density);
}
