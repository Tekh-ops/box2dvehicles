...
void b2PrismaticJoint::SetAnchorA(b2Vec2 p)
{
        m_localAnchor1 = m_bodyA->GetLocalPoint(p);
}

void b2PrismaticJoint::SetAnchorB(b2Vec2 p)
{
        m_localAnchor2 = m_bodyB->GetLocalPoint(p);
}

void b2PrismaticJoint::SetAxis(b2Vec2 localAxis)
{
    m_localXAxis1 = localAxis;
    m_localYAxis1 = b2Cross(1.0f, m_localXAxis1);
...
void b2PrismaticJoint::SetReferenceAngle(float32 angle)
{
    m_refAngle = angle;
}
