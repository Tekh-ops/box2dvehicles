...
void b2WheelJoint::SetAnchorA(b2Vec2 p)
{
        m_localAnchorA = m_bodyA->GetLocalPoint(p);
}

void b2WheelJoint::SetAnchorB(b2Vec2 p)
{
        m_localAnchorB = m_bodyB->GetLocalPoint(p);
}

void b2WheelJoint::SetAxis(b2Vec2 localAxis)
{
    m_localXAxisA = localAxis;
    m_localYAxisA = b2Cross(1.0f, m_localXAxisA);
