...
@interface box2dvehiclesViewController ()
...
@implementation box2dvehiclesViewController

@synthesize animating, context, zoomSlider;
...
- (void)drawFrame
{
	...
	if (m_vehiclesDemo) {
		m_vehiclesDemo->Step();
		m_vehiclesDemo->Render(zoomSlider.value);
	}
...
{
	if ( m_vehiclesDemo )
		delete m_vehiclesDemo;
	m_vehiclesDemo = new VehiclesDemo();
}

- (IBAction)changeVehicle
{
	if ( m_vehiclesDemo )
		m_vehiclesDemo->ButtonDown(VehiclesDemo::b_change);
}

- (IBAction)leftButtonDown
{
	if ( m_vehiclesDemo )
		m_vehiclesDemo->ButtonDown(VehiclesDemo::b_left);
}

- (IBAction)rightButtonDown
{
	if ( m_vehiclesDemo )
		m_vehiclesDemo->ButtonDown(VehiclesDemo::b_right);
}

- (IBAction)leftButtonUp
{
	if ( m_vehiclesDemo )
		m_vehiclesDemo->ButtonUp(VehiclesDemo::b_left);
}

- (IBAction)rightButtonUp
{
	if ( m_vehiclesDemo )
		m_vehiclesDemo->ButtonUp(VehiclesDemo::b_right);
}
